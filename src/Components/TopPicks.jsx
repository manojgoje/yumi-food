      ...
      <Slider {...settings}>
      {
        topPicks.map((item,i)=>(
          <div className=' rounded-md ' key={item.id}>
              ...
              <img src={item.img} alt="" className='w-[200px] rounded-full object-cover h-[200px]' />
              </div>
              ...
              <button className='bg-black w-[100px] text-white rounded-md my-6 py-[10px] text-[15px] font-semibold hover:text-[#fbc531]' onClick={handleAdd}>Add to Cart </button>
              </div>
          </div>
        ))
      }
