...
const SignIn = () => {
  return (
    <div className=" text-gray-700 body-font w-[90%] sm:w-[80%] mx-auto mt-[100px]  ">
      <div className=" container px-5 py-24  mx-auto flex flex-wrap items-center ">
        <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0 ">
          <h1 className=" title-font font-medium text-3xl text-gray-900 ">
            Get Strated with your Account
          </h1>
          <p className=" leading-relaxed mt-4">
            {" "}
            FInd Your Favourite Food on our platfrm . just one step to order
            your food
          </p>
        </div>

        <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 ">
          <h2 className=" text-gray-700 text-lg font-medium title-font mb-5">
            Sign up
          </h2>
          <div className=" relative mb-4 ">
            ...
            <button className= " w-full mt-4 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg ">
              Sign Up
            </button>
          </div>
        </div>
